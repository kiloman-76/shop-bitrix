sekdfhkdefertretertretretertre<? if (!defined('B_PROLOG_INCLUDED') || B_PROLOG_INCLUDED !== true) die();
...
<div class="catalog-section test bx-<?=$arParams['TEMPLATE_THEME']?>" data-entity="<?=$containerName?>">
	<?
					...
					case 1:
						...
						<div class="col-xs-12 product-item-small-card">
							<div class="row">
								...
								{
									?>
									<div class="col-xs-6 test product-item-big-card">
										<div class="row">
											<div class="col-md-12">
												<?
												$APPLICATION->IncludeComponent(
